...
const TV_CRITERIA = [
  ...
  { key: "characters", label: "Персонажи",          weight: "20%",
    tip: "Проработка персонажей. Для обычных сериалов — развитие на протяжении сезонов. Для антологий — глубина и убедительность персонажей внутри каждой истории. Для мультсериалов — самобытность и харизма героев." },
