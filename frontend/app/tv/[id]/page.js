...
const TV_CRITERIA = [
  ...
  { key: "acting",     label: "Актёрская игра / Озвучка", weight: "15%",
    tip: "Насколько хорошо актёры воплощают написанных персонажей. Для мультсериалов — качество озвучки: интонации, характерность голосов. Актёры могут спасти слабого персонажа или загубить сильного — это отдельный критерий от написания." },
