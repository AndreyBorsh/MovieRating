...
const TV_CRITERIA = [
  ...
  { key: "characters", label: "Персонажи",          weight: "20%",
    tip: "Проработка персонажей, их развитие на протяжении сезонов. Насколько они живые, интересные, неоднозначные?" },
  { key: "acting",     label: "Актёрская игра",     weight: "15%",
    tip: "Убедительность актёрской игры. В сериале актёры на виду гораздо дольше, чем в фильме — это особенно важно." },
  ...
  { key: "pacing",     label: "Темп и динамика",    weight: "5%",
    tip: "Ритм повествования, отсутствие воды и затянутых сцен. Хочется ли смотреть следующую серию не отрываясь?" },
];

const TV_FORMULA_TEXT =
  "30%·Общее + 20%·Сценарий + 20%·Персонажи + 15%·Актёры + 10%·Визуал + 5%·Темп";
